...
<li data-key="<?php echo $key ?>" class="woof_options_li">
    ...
    <input type="hidden" name="woof_settings[<?php echo $key ?>][reset_behavior]" value="<?php echo stripcslashes($woof_settings[$key]['reset_behavior']) ?>" />
    <div id="woof-modal-content-<?php echo $key ?>" style="display: none;">
        ...
        <div class="woof-form-element-container">
            ...
            <div class="woof-name-description">
                <strong><?php _e('Behavior of reset button', 'woocommerce-products-filter') ?></strong>
                <span><?php _e('Make filtering after clearing the SKU field or just clear the text input.', 'woocommerce-products-filter') ?></span>
            </div>

            <div class="woof-form-element">
                <?php
                $reset_behavior = array(
                    1 => __('Make filtering', 'woocommerce-products-filter'),
                    0 => __('Clear text input', 'woocommerce-products-filter'),
                );
                ?>
