...
function wishlist_settings_content_general(){
    ...
    <div class="section">
        ...
        $args = array(
            ...
            'details'	=> __('Set default wishlist id.','post-grid'),
            'type'		=> 'text',
        ...
        $args = array(
            'id'		=> 'wishlist_slug',
            'parent'		=> 'wishlist_settings',
            'title'		=> __('Wishlist slug','post-grid'),
            'details'	=> __('Set wishlist slug','post-grid'),
            'type'		=> 'text',
            'value'		=> $wishlist_slug,
            'default'		=> '',
...
function wishlist_settings_content_my_wishlist(){
    ...
    ?>
    <div class="section">
        <div class="section-title"><?php echo __('My wishlist\'s', 'post-grid'); ?></div>
        <p class="description section-description"><?php echo __('Choose My wishlist options.', 'post-grid'); ?></p>
        ...
        $args = array(
            ...
            'title'		=> __('My wishlist page','post-grid'),
            'details'	=> __('Users will able to view their wishlist\'s, use shortcode <code>[my_wishlist]</code> on that page.','post-grid'),
            'type'		=> 'select',
        ...
        $args = array(
            ...
            'parent'		=> 'wishlist_settings[my_wishlist]',
            'title'		=> __('Item per page','post-grid'),
            'details'	=> __('Set custom number of item per page.','post-grid'),
            'type'		=> 'text',
...
if(!function_exists('wishlist_settings_content_help_support')) {
    function wishlist_settings_content_help_support($tab){
        ...
        <div class="section">
            ...
            <textarea onclick="this.select()">&#60;?php echo do_shortcode( '&#91;wishlist_button id="123" show_count="yes" show_menu="yes" icon_active="" icon_inactive="" icon_loading="" &#93;' ); ?&#62;</textarea>
