...
<div class="woocommerce-wishlist-container woocommerce">
	<div class="woocommerce-wishlist-search-form">
		<input type="text" id="woocommerce-wishlist-search" name="woocommerce_wishlist_search" placeholder="<?php echo __('Search for Public Wishlists.', 'woocommerce-wishlist'); ?>">
	</div>
